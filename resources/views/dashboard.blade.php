                            ...
                            @if (auth()->user()->role == 0)
                                <div>
                                    <button type="button"
                                        ...
                                        onclick="openModal('modelDelete{{ $santri->nis }}')">
                                ...
                                <div id="modelDelete{{ $santri->nis }}"
                                    class="fixed hidden z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4 ">
                                    <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
                                        <div class="flex justify-end p-2">
                                            <button onclick="closeModal('modelDelete{{ $santri->nis }}')"
                                                type="button"
                                        ...
                                        <div class="p-6 pt-0 text-center">
                                            ...
                                            <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">Yakin Untuk
                                                Menghapus Data?
                                            </h3>
                                            <form
                                                action="/dashboard/santri/{{ $santri->nis ?? 'NIS tidak tersedia' }}"
                                                method="POST">
                                                @method('delete')
                                                @csrf
                                                <button type="submit"
                                                ...
                                                <a href="#"
                                                    onclick="closeModal('modelDelete{{ $santri->nis }}')"
